...
if __name__ == "__main__":
	...
	fragments = ["1000","500","250","200"]
		
	all = ["ChIP-seq/H3K27ac-human/H3K27ac.tsv","ChIP-seq/H3K9me3-human/H3K9me3.tsv","ChIP-seq/H3K27me3-human/H3K27me3.tsv","ChIP-seq/H3K4me3-human/H3K4me3.tsv","ChIP-seq/H3K4me1-human/H3K4me1.tsv","ChIP-seq/H3K4me2-human/H3K4me2.tsv","ChIP-seq/H3K9ac-human/H3K9ac.tsv"]
	...
	for fragment in fragments:
		for folder in folders:
			cell = folder.split("/")[-2]
			command = "python3.4 ../01_make_central_vectors/makeCentralVector.py "
			...
			command += "-o ../02_central_vectors/"+Class+"_core/"+cell+"/"+fragment+" "
			...
			f.write("#!/bin/bash\n")
			f.write("#SBATCH -c 8\n")
			f.write("#SBATCH --job-nam=job"+str(cont)+"\n")
			f.write(command)
			f.close()
			s("sbatch job.sh")
			cont += 1
